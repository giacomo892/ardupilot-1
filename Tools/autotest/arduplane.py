...
#            self.context_clear_collection("STATUSTEXT")
    ...
    def manual_rtl_alt_control(self):
        self.wait_ready_to_arm()
        rtl_alt = 100 # m
        self.set_parameters({
            "FLIGHT_OPTIONS": (1<<19),
        ...
        self.set_rc(2, 1100)
        self.wait_altitude(95, 105, timeout=30, relative=True)
        self.progress("Manually descending to 50m")
        self.set_rc(2, 1900)
        self.wait_altitude(45, 55, timeout=30, relative=True)
        self.set_rc(2, 1500)
        ...
        self.wait_distance_to_home(90, 110, timeout=120)
        self.delay_sim_time(60)
        self.wait_distance_to_home(90, 110, timeout=120)
        self.progress("Unfailsafe and climb to 200m")
        self.set_parameter("SIM_RC_FAIL", 0)
        self.set_rc(2, 1100)
        self.wait_altitude(195, 205, timeout=30, relative=True)
 ...
 indicating slope was replanned unexpectedly")
    ...
    def tests(self):
        ...
        ret.extend([
            ...
            ("CruiseRudderControl",
             "Test cruise mode rudder control",
             self.cruise_rudder_control),
            ...
            ("ManualRTLAltControl",
             "Test manual RTL alt control",
             self.manual_rtl_alt_control),
